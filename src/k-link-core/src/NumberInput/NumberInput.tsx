...
import { useMergedRef, assignRef, useOs, clamp } from '@k-link/hooks';
import { DefaultProps, Selectors, useComponentDefaultProps, rem, getSize } from '@k-link/styles';
...
NumberInput.displayName = '@k-link/core/NumberInput';
