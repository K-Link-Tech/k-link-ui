...
import { useId, useUncontrolled } from '@k-link/hooks';
import { Selectors, DefaultProps, useComponentDefaultProps, rem, getSize } from '@k-link/styles';
...
PasswordInput.displayName = '@k-link/core/PasswordInput';
