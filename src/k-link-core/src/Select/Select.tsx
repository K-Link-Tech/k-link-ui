...
import { useUncontrolled, useMergedRef, useDidUpdate, useScrollIntoView } from '@k-link/hooks';
import { DefaultProps, MantineSize, MantineShadow, getDefaultZIndex } from '@k-link/styles';
import { groupOptions } from '@k-link/utils';
        ...
        <SelectPopover.Target>
          ...
          >
            ...
            <Input<'input'>
              ...
              disabled={disabled}
              data-k-link-stop-propagation={shouldShowDropdown}
              name={null}
              classNames={{
                ...classNames,
...
Select.displayName = '@k-link/core/Select';
